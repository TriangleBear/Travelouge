...
class UploadPhotoScreen extends StatelessWidget {
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Container(
                                                                            height:
                                                                                getVerticalSize(657),
                                                                            width: double.maxFinite,
                                                                            decoration: BoxDecoration(color: ColorConstant.teal1009e)))
                                                                  ]))),
                                                      Align(
                                                          alignment: Alignment
                                                              .topCenter,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                                            children: [
                                                                              CustomAppBar(height: getVerticalSize(60), leadingWidth: 132, leading: AppbarImage(height: getVerticalSize(60), width: getHorizontalSize(62), imagePath: ImageConstant.imgArrow, margin: getMargin(right: 70)), title: AppbarSubtitle(text: "ALL NOTES", margin: getMargin(left: 54, top: 17, bottom: 18)), actions: [
                                                                                AppbarImage(
                                                                                    height: getVerticalSize(39),
                                                                                    width: getHorizontalSize(38),
                                                                                    imagePath: ImageConstant.imgSaved,
                                                                                    margin: getMargin(left: 11, top: 12, right: 11, bottom: 9),
                                                                                    onTap: () {
                                                                                      onTapSaved1(context);
                                                                                    })
                                                                              ]),
                                                                              Divider(height: getVerticalSize(2), thickness: getVerticalSize(2), color: ColorConstant.teal300A7)
                                                                            ]))
                                                                  ]))),
                                                      Align(
                                                          alignment: Alignment
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            style: AppStyle.txtBoogalooRegular40Teal900)),
                                                                    Padding(
                                                                        padding: getPadding(
                                                                            left:
                                                                                2),
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
                                                                            textAlign: TextAlign.left,
                                                                            style: AppStyle.txtSourceCodeProRomanSemiBold24.copyWith(letterSpacing: getHorizontalSize(2.4))))
                                                                  ]))),
                                                      CustomImageView(
                                                          imagePath:
                                                              ImageConstant
  ...
  onTapSaved1(BuildContext context) {
